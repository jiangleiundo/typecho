    ...
    <div class="row">
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            ...
            <?php if (isset($_GET['finish'])) : ?>
                ...
                <?php else : ?>
                    <?php
                    //You need to be running PHP 5.4+ to use shorthand arrays --下面试着修改代码不知是否可行，下面还有第二种修改来自：
                    // https://zhidao.baidu.com/question/686284333130022852.html?hideOtherAnswer=true&newAnswer=1
